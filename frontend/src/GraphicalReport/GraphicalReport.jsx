...
const StudentHistoryGraph = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://localhost:8000/studenthistory/${stuId}`);
...
export default StudentHistoryGraph;
